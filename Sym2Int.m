...
AppendTo[result,Row[{Style["Version: 2.1; Author: Renato Fonseca.",{GrayLevel[0.5]}]}]];
AppendTo[result,Row[{Style["The Sym2Int program list all possible interactions with a given list of fields. ",{GrayLevel[0.5]}]}]];
...
buttonPPF=Button[Style[Column[{"Pisano-Pleitez-","-Frampton 331 Model"},Center],{Darker[Red],Bold,FontFamily->"Consolas"}],CellPrint[Cell[BoxData[PPFexample],"Input",Background->Lighter[Orange,0.9]]],Appearance->"DialogBox"];
buttonSVS=Button[Style[Column[{"Singer-Valle-","-Schechter 331 Model"},Center],{Darker[Red],Bold,FontFamily->"Consolas"}],CellPrint[Cell[BoxData[SVSexample],"Input",Background->Lighter[Orange,0.9]]],Appearance->"DialogBox"];
